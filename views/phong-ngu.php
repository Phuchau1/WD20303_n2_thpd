...
$category = $categoryModel->getBySlug('phong-ngu');
if (!$category) {
  http_response_code(404);
  echo "<h1>Danh mục 'Phòng Ngủ' không tìm thấy</h1>";
  exit;
}
...
<head>
  <meta charset="utf-8">
  <title>Phòng Ngủ - Sản phẩm</title>
...
<body>
  ...
  <head>
    ...
    <title>Phòng Ngủ - Nội Thất Cao Cấp</title>
    <meta name="description" content="Nội thất phòng ngủ cao cấp, hiện đại, sang trọng">
    <meta property="og:title" content="Phòng Ngủ - Nội Thất Cao Cấp">
    <meta property="og:description" content="Nội thất phòng ngủ cao cấp, hiện đại, sang trọng">
  ...
  <main class="container" style="padding:28px 16px;">
    <div class="section-title">
      <h2>Phòng Ngủ</h2>
      <!-- Removed the display line for consistency -->
    </div>
    ...
    <section class="section about-room" style="background: linear-gradient(90deg, #f5f5f5 60%, #fbeee6 100%); margin-top: 60px;">
      <div class="container" style="display: flex; flex-wrap: wrap; align-items: center; gap: 40px;">
        <div style="flex:1 1 320px; min-width:260px;">
          <img src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=600&h=400&fit=crop" alt="Phòng ngủ hiện đại" style="width:100%; border-radius:18px; box-shadow:0 8px 32px rgba(198,164,126,0.13);">
        </div>
        <div style="flex:2 1 400px; min-width:260px;">
          <h2 style="font-size:2.2rem; color:#c6a47e; font-family:var(--font-heading); margin-bottom:18px;">Không Gian Phòng Ngủ Hiện Đại</h2>
          <p style="font-size:1.15rem; color:#333; margin-bottom:18px;">Phòng ngủ là nơi nghỉ ngơi, tái tạo năng lượng. Chúng tôi mang đến các sản phẩm nội thất phòng ngủ cao cấp, thiết kế tinh tế, tối ưu không gian và mang lại cảm giác thư thái.</p>
          <ul style="font-size:1rem; color:#555; margin-bottom:18px; line-height:1.8;">
            <li>Giường ngủ, tủ, bàn trang điểm đa dạng</li>
            <li>Chất liệu an toàn, thân thiện</li>
            <li>Thiết kế tối ưu diện tích</li>
