...
$category = $categoryModel->getBySlug('phong-bep');
if (!$category) {
...
<body>
  ...
  <head>
    ...
    <title>Phòng Bếp - Nội Thất Cao Cấp</title>
    <meta name="description" content="Nội thất phòng bếp cao cấp, hiện đại, sang trọng">
    <meta property="og:title" content="Phòng Bếp - Nội Thất Cao Cấp">
    <meta property="og:description" content="Nội thất phòng bếp cao cấp, hiện đại, sang trọng">
    ...
    <section class="section about-room" style="background: linear-gradient(90deg, #f5f5f5 60%, #fbeee6 100%); margin-top: 60px;">
      <div class="container" style="display: flex; flex-wrap: wrap; align-items: center; gap: 40px;">
        <div style="flex:1 1 320px; min-width:260px;">
          <img src="https://images.unsplash.com/photo-1464983953574-0892a716854b?w=600&h=400&fit=crop" alt="Phòng bếp hiện đại" style="width:100%; border-radius:18px; box-shadow:0 8px 32px rgba(198,164,126,0.13);">
        </div>
        <div style="flex:2 1 400px; min-width:260px;">
          <h2 style="font-size:2.2rem; color:#c6a47e; font-family:var(--font-heading); margin-bottom:18px;">Không Gian Phòng Bếp Hiện Đại</h2>
          <p style="font-size:1.15rem; color:#333; margin-bottom:18px;">Phòng bếp là trái tim của ngôi nhà. Chúng tôi mang đến các sản phẩm nội thất phòng bếp hiện đại, tiện nghi, giúp bạn tận hưởng từng khoảnh khắc bên gia đình.</p>
          <ul style="font-size:1rem; color:#555; margin-bottom:18px; line-height:1.8;">
            <li>Tủ bếp, bàn ăn, ghế đa dạng</li>
            <li>Chất liệu cao cấp, dễ vệ sinh</li>
