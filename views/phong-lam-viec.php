...
// Resolve the category by slug 'phong-lam-viec'
$category = $categoryModel->getBySlug('phong-lam-viec');
if (!$category) {
  http_response_code(404);
  echo "<h1>Danh mục 'Phòng Làm Việc' không tìm thấy</h1>";
  exit;
}
...
<body>
  ...
  <head>
    ...
    <title>Phòng Làm Việc - Nội Thất Cao Cấp</title>
    <meta name="description" content="Nội thất phòng làm việc cao cấp, hiện đại, sang trọng">
    <meta property="og:title" content="Phòng Làm Việc - Nội Thất Cao Cấp">
    <meta property="og:description" content="Nội thất phòng làm việc cao cấp, hiện đại, sang trọng">
    ...
    <section class="section about-room" style="background: linear-gradient(90deg, #f5f5f5 60%, #fbeee6 100%); margin-top: 60px;">
      <div class="container" style="display: flex; flex-wrap: wrap; align-items: center; gap: 40px;">
        <div style="flex:1 1 320px; min-width:260px;">
          <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=600&h=400&fit=crop" alt="Phòng làm việc hiện đại" style="width:100%; border-radius:18px; box-shadow:0 8px 32px rgba(198,164,126,0.13);">
        </div>
        <div style="flex:2 1 400px; min-width:260px;">
          <h2 style="font-size:2.2rem; color:#c6a47e; font-family:var(--font-heading); margin-bottom:18px;">Không Gian Phòng Làm Việc Hiện Đại</h2>
          <p style="font-size:1.15rem; color:#333; margin-bottom:18px;">Phòng làm việc cần sự tập trung và cảm hứng. Chúng tôi mang đến các sản phẩm nội thất phòng làm việc hiện đại, tối ưu công năng, giúp bạn làm việc hiệu quả hơn mỗi ngày.</p>
          <ul style="font-size:1rem; color:#555; margin-bottom:18px; line-height:1.8;">
            <li>Bàn làm việc, giá sách, ghế công thái học</li>
            <li>Chất liệu bền đẹp, dễ vệ sinh</li>
            <li>Thiết kế tối ưu không gian nhỏ</li>
